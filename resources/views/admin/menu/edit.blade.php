    ...
    <div class="min-h-screen p-4 md:p-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 bg-white rounded-2xl shadow p-6 md:p-8">
                ...
                <form action="{{ route('admin.menu.update', $menu->id) }}" method="POST" class="space-y-5"
                    ...
                    <div>
                        ...
                        <select name="kategori_id"
                            ...
                            @foreach ($kategori as $item)
                                <option value="{{ $item->id }}" {{ old('kategori_id', $menu->kategori_id) == $item->id ? 'selected' : '' }}>
                                    {{ $item->nama }}
                                </option>
                            @endforeach
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" rows="4"
                            class="w-full mt-2 px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-orange-400 focus:outline-none"
                            placeholder="Deskripsi kategori...">{{ old('deskripsi', $menu->deskripsi) }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="file" name="gambar" id="gambar"
                            src="{{ $menu->gambar ? asset('storage/' . $menu->gambar) : 'https://via.placeholder.com/150' }}"
                    ...
                    <div>
                        ...
                        <input type="radio" name="tersedia" value="1" class="mr-2" {{ old('tersedia', $menu->tersedia) == 1 ? 'checked' : '' }}>
                        <label class="mr-4">Ya</label>
                        <input type="radio" name="tersedia" value="0" class="mr-2" {{ old('tersedia', $menu->tersedia) == 0 ? 'checked' : '' }}>
                        <label>Tidak</label>
            ...
            <div class="bg-white rounded-2xl shadow p-6 h-fit">
                ...
                <div class="space-y-3 text-sm text-gray-700">
                    ...
                    <div>
                        ...
                        <img id="preview-gambar" src="{{ $menu->gambar ? asset('storage/' . $menu->gambar) : 'https://via.placeholder.com/150?text=Preview' }}"
