    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        ...
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">
                Dashboard → Meja: {{ $meja->nomor_meja }} → Detail
            </p>
        </div>

        <!-- ACTION BUTTON -->
        <div class="flex flex-wrap gap-2 mt-4 md:mt-0">
            <a href="{{ route('admin.meja.edit', $meja->id) }}"
            ...
            <a href="#" target="_blank" class="px-4 py-2 bg-green-600 text-white rounded-xl shadow hover:bg-green-700 text-sm">
                Cetak PDF
            </a>
